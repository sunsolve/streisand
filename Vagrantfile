...
Vagrant.configure(2) do |config|
  ...
  config.vm.define "streisand_host", primary: true do |streisand|
    streisand.vm.hostname = "streisand_host"
  ...
  config.vm.define "streisand_client" do |client|
    client.vm.hostname = "streisand_client"
